...
object GeminiApi {
    ...
    fun analyzeBreed(imageBase64: String, onResult: (String) -> Unit, onError: (String) -> Unit) {
        ...
        // ✅ Correct JSON body for Gemini 2.0 Flash
        ...
        // Proper JSONArray for "parts"
        val partsArray = JSONArray()
            .put(textObject)
            .put(imageObject)

        // Proper JSONArray for "contents"
        ...
        Log.d("GeminiApi", "Sending fixed request to Gemini 2.0 model...")
